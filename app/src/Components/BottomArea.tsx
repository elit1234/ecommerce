...
const BottomArea = () => {
  ...
  return (
    <div className="bottomArea">
      <Link
        className={`bottomAreaOption ${
          pathname.startsWith("/store") ? "bottomAreaOptionActive" : ""
        } `}
        to="/store"
      >
      ...
      <Link
        to="/search"
        className={`bottomAreaOption ${
          pathname.startsWith("/search") ? "bottomAreaOptionActive" : ""
        } `}
      >
      ...
      <Link
        to="/cart"
        className={`bottomAreaOption ${
          pathname.startsWith("/cart") ? "bottomAreaOptionActive" : ""
        } `}
      >
      ...
      <Link
        to="/account"
        className={`bottomAreaOption ${
          pathname.startsWith("/account") ? "bottomAreaOptionActive" : ""
        } `}
      >
